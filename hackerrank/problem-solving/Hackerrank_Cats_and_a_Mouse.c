...
/* We just have to compare the difference between the CatA and MouseC
   and CatB and MouseC (remember to take positive value of difference
   as we are provided with their positions on the x axis)     */
