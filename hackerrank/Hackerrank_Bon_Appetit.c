...
/* calculate the sum of all prices except the one that is allergic to Anna
   and divide the sum by 2, if sum is equal to value charged by Brian then
   print Bon Appetit otherwise print difference of value charged and sum
   divided by 2. */
